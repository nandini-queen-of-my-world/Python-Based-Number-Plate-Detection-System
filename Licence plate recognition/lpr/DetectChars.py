...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = npaClassifications = np.loadtxt("C:/Users/mksg0/OneDrive/Desktop/FINAL PY/lpr/classifications.txt", np.float32)
    ...
    try:
        npaFlattenedImages = np.loadtxt("C:/Users/mksg0/OneDrive/Desktop/FINAL PY/lpr/flattened_images.txt", np.float32)
    except:
...
def findListOfMatchingChars(possibleChar, listOfChars):
    ...
    for possibleMatchingChar in listOfChars:
        ...
        fltChangeInArea = float(abs(
            possibleMatchingChar.intBoundingRectArea - possibleChar.intBoundingRectArea)) / float(
            possibleChar.intBoundingRectArea)
        fltChangeInWidth = float(abs(
            possibleMatchingChar.intBoundingRectWidth - possibleChar.intBoundingRectWidth)) / float(
            possibleChar.intBoundingRectWidth)
        fltChangeInHeight = float(abs(
            possibleMatchingChar.intBoundingRectHeight - possibleChar.intBoundingRectHeight)) / float(
